    ...
    return (
        <div className="homePage d-flex align-items-center">
            <header className="cuadroPrincipal p-3 justify-content-center container">
                <h1 className="row mt-4 p-3 justify-content-center">Proyect Rick & Morty</h1>
                ...
                <div className="row justify-content-center">
                    <ButtonsHome className="d-flex" tituloBoton="Characters"/>
                    <ButtonsHome className="d-flex" tituloBoton="Contact"/>
                </div>
            </header>
        </div>
    )
